...
New wallet, like Metamask but for being a Global Citizen of Planet Earth ---> Proof of Identity

You can be a Global Citizen
You can be a Company 
You can be a Government (Nation)


A new Software Wallet used to interact with Global Digital Jurisdiction of Planet Earth 

It allows users (Global citizens, Private Sector, Nations) to access their wallet through a browser extension or mobile app,
which can then be used to interact with decentralized applications on the GLOBAL DIGITAL JURISDICTION OF THE PLANET EARTH.

-->  PLANET EARTH wallet (Planning Merge with Consensys)
...
Copyright and related rights waived via [CC0](https://creativecommons.org/publicdomain/zero/1.0/). https://github.com/ethereum/EIPs/blob/master/EIPS/eip-1102.md
